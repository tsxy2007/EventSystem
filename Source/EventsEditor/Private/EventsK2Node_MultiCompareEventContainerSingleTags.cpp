...
#include "EventsK2Node_MultiCompareEventContainerSingleTags.h"
...
UEventsK2Node_MultiCompareEventContainerSingleTags::UEventsK2Node_MultiCompareEventContainerSingleTags(const FObjectInitializer& ObjectInitializer)
	: Super(ObjectInitializer)
{
}

void UEventsK2Node_MultiCompareEventContainerSingleTags::AllocateDefaultPins()
{
	PinNames.Reset();
	...
	CreatePin(EGPD_Input, UEdGraphSchema_K2::PC_Struct, FEventContainer::StaticStruct(), TEXT("Gameplay Tag Container"), PinParams);
}

void UEventsK2Node_MultiCompareEventContainerSingleTags::ExpandNode(class FKismetCompilerContext& CompilerContext, UEdGraph* SourceGraph)
{
	...
	for (int32 Index = 0; Index < NumberOfPins; ++Index)
	{
		...
		const UFunction* Function = UBlueprintEventLibrary::StaticClass()->FindFunctionByName(GET_FUNCTION_NAME_CHECKED(UBlueprintEventLibrary, HasTag));
...
FText UEventsK2Node_MultiCompareEventContainerSingleTags::GetNodeTitle(ENodeTitleType::Type TitleType) const
{
	return NSLOCTEXT("K2Node", "MultiCompare_TagContainerSingleTags", "Compare Tag Container to Other Tags");
}

void UEventsK2Node_MultiCompareEventContainerSingleTags::GetMenuActions(FBlueprintActionDatabaseRegistrar& ActionRegistrar) const
{
...
void UEventsK2Node_MultiCompareEventContainerSingleTags::AddPinToSwitchNode()
{
