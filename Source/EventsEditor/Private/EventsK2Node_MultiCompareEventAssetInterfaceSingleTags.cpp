...
#include "EventsK2Node_MultiCompareEventAssetInterfaceSingleTags.h"
...
UEventsK2Node_MultiCompareEventAssetInterfaceSingleTags::UEventsK2Node_MultiCompareEventAssetInterfaceSingleTags(const FObjectInitializer& ObjectInitializer)
	: Super(ObjectInitializer)
{
}

void UEventsK2Node_MultiCompareEventAssetInterfaceSingleTags::AllocateDefaultPins()
{
	PinNames.Reset();
	...
	CreatePin(EGPD_Input, UEdGraphSchema_K2::PC_Interface, UEventAssetInterface::StaticClass(), TEXT("Gameplay Tag Asset Interface"));
}

void UEventsK2Node_MultiCompareEventAssetInterfaceSingleTags::ExpandNode(class FKismetCompilerContext& CompilerContext, UEdGraph* SourceGraph)
{
	...
	for (int32 Index = 0; Index < NumberOfPins; ++Index)
	{
		...
		const UFunction* Function = UBlueprintEventLibrary::StaticClass()->FindFunctionByName(GET_FUNCTION_NAME_CHECKED(UBlueprintEventLibrary, DoesTagAssetInterfaceHaveTag));
...
FText UEventsK2Node_MultiCompareEventAssetInterfaceSingleTags::GetNodeTitle(ENodeTitleType::Type TitleType) const
{
	return NSLOCTEXT("K2Node", "MultiCompare_TagAssetInterfaceSingleTags", "Compare Tag Asset Interface to Other Tags");
}

void UEventsK2Node_MultiCompareEventAssetInterfaceSingleTags::GetMenuActions(FBlueprintActionDatabaseRegistrar& ActionRegistrar) const
{
...
void UEventsK2Node_MultiCompareEventAssetInterfaceSingleTags::AddPinToSwitchNode()
{
	...
	CreatePin(EGPD_Input, UEdGraphSchema_K2::PC_Struct, FEventInfo::StaticStruct(), InPin, InPinParams);
