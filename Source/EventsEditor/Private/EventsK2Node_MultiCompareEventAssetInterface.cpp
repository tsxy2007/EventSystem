...
#include "EventsK2Node_MultiCompareEventAssetInterface.h"
...
UEventsK2Node_MultiCompareEventAssetInterface::UEventsK2Node_MultiCompareEventAssetInterface(const FObjectInitializer& ObjectInitializer)
	: Super(ObjectInitializer)
{
}

void UEventsK2Node_MultiCompareEventAssetInterface::AllocateDefaultPins()
{
	PinNames.Reset();
...
void UEventsK2Node_MultiCompareEventAssetInterface::ExpandNode(class FKismetCompilerContext& CompilerContext, UEdGraph* SourceGraph)
{
	...
	for (int32 Index = 0; Index < NumberOfPins; ++Index)
	{
		...
		const UFunction* Function = UBlueprintEventLibrary::StaticClass()->FindFunctionByName(GET_FUNCTION_NAME_CHECKED(UBlueprintEventLibrary, HasAllMatchingEvents));
...
FText UEventsK2Node_MultiCompareEventAssetInterface::GetNodeTitle(ENodeTitleType::Type TitleType) const
{
	return NSLOCTEXT("K2Node", "MultiCompare_AssetInterface", "Compare Tag Asset Interface to Other Tag Containers");
}

void UEventsK2Node_MultiCompareEventAssetInterface::GetMenuActions(FBlueprintActionDatabaseRegistrar& ActionRegistrar) const
{
...
void UEventsK2Node_MultiCompareEventAssetInterface::AddPinToSwitchNode()
{
