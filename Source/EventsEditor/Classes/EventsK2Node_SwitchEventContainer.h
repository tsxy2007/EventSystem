...
#include "EventsK2Node_SwitchEventContainer.generated.h"

class FBlueprintActionDatabaseRegistrar;

UCLASS(MinimalAPI)
class UEventsK2Node_SwitchEventContainer : public UK2Node_Switch
{
	GENERATED_UCLASS_BODY()

	UPROPERTY(EditAnywhere, Category = PinOptions)
	TArray<FEventContainer> PinContainers;
