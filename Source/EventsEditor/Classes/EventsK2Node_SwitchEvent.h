...
#include "EventsK2Node_SwitchEvent.generated.h"

class FBlueprintActionDatabaseRegistrar;

UCLASS(MinimalAPI)
class UEventsK2Node_SwitchEvent : public UK2Node_Switch
{
	...
	EVENTSEDITOR_API virtual void AddPinToSwitchNode() override;
	virtual FName GetUniquePinName() override;
	virtual FEdGraphPinType GetPinType() const override;
	EVENTSEDITOR_API virtual FEdGraphPinType GetInnerCaseType() const override;
